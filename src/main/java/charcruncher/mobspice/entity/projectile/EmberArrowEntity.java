package charcruncher.mobspice.entity.projectile;
...
import charcruncher.mobspice.ModEntities;
import charcruncher.mobspice.ModItems;
import charcruncher.mobspice.block.GlowingEmbersBlock;
...
import net.minecraft.entity.projectile.PersistentProjectileEntity;
import net.minecraft.item.ItemStack;
import net.minecraft.item.Items; // For example, if you want it to drop a specific item
...
public class EmberArrowEntity extends PersistentProjectileEntity {
    ...
    protected void onBlockHit(BlockHitResult blockHitResult) {
        ...
        if (world.getBlockState(placePos).isAir()) {
            // If the block is air, we can place glowing embers
            ...
            // If the block is already glowing embers, we can just update it
